...
ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();
	...
	public void deploymentProcessDefinition_inputStream() {
		InputStream inputStreamBpmn = this.getClass().getClassLoader().getResourceAsStream("diagrams/groupTask2.xml");
		InputStream inputStreamPng = this.getClass().getClassLoader().getResourceAsStream("diagrams/groupTask2.png");
	...
	public void finHistoryTask() {
		String processInstanceId = "325001";
