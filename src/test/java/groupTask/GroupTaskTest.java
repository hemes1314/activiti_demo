...
ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();
	...
	public void deploymentProcessDefinition_inputStream() {
		InputStream inputStreamBpmn = this.getClass().getClassLoader().getResourceAsStream("diagrams/groupTask.xml");
		InputStream inputStreamPng = this.getClass().getClassLoader().getResourceAsStream("diagrams/groupTask.png");
	...
	public void finHistoryTask() {
		String processInstanceId = "310001";
